// Fallback Navbar defined inline to avoid missing module error
function Navbar() {
  return (
    <header style={{ width: "100%", padding: "16px 32px", boxSizing: "border-box" }}>
      <div style={{ maxWidth: 1200, margin: "0 auto", display: "flex", alignItems: "center", justifyContent: "space-between" }}>
        <div style={{ color: "#60a5fa", fontWeight: 700 }}>DemacroLearn</div>
        <nav style={{ display: "flex", gap: 12 }}>
          <a style={{ color: "#94a3b8", textDecoration: "none" }}>Features</a>
          <a style={{ color: "#94a3b8", textDecoration: "none" }}>Pricing</a>
          <a style={{ color: "#94a3b8", textDecoration: "none" }}>Docs</a>
        </nav>
      </div>
    </header>
  );
